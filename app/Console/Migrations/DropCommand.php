...
class DropCommand extends Command {
     ...
     */
     protected $description = 'Drop database if existed';
    ...
    public function dropDatabase()
    {
        ...
        try {
            ...
            $this->info(sprintf('Successfully dropped database'));
        } catch (DriverException $e) {
            $this->error(sprintf('Failed to dropped database, because of error:'. $e->getMessage()));
        }
    } 
